...
DROP TABLE dbo.COLECTAEMPLEADO;
DROP TABLE dbo.COLECTA;
...
DROP TABLE dbo.MENSAJE_PRINCIPAL;
...
(
	...
	CONSTRAINT PK_COLECTA PRIMARY KEY(Id),
	CONSTRAINT FK_EmpleadoId_COLECTA FOREIGN KEY (IdEmpleado) REFERENCES dbo.EMPLEADO (EmpleadoId)
);
GO

CREATE TABLE dbo.COLECTAEMPLEADO
(
	EmpleadoId INT  NOT NULL,
	ColectaId INT  NOT NULL,
	MontoPesos NUMERIC(12,2) NOT NULL,
	MontoDolares NUMERIC(12,2) NOT NULL,

	CONSTRAINT PK_COLECTAEMPLEADO PRIMARY KEY(EmpleadoId, ColectaId),
	CONSTRAINT FK_EmpleadoId_COLECTAEMPLEADO FOREIGN KEY (EmpleadoId) REFERENCES dbo.EMPLEADO (EmpleadoId),
	CONSTRAINT FK_ColectaId_COLECTAEMPLEADO FOREIGN KEY (ColectaId) REFERENCES dbo.COLECTA (Id)
);
GO
...
CREATE TABLE dbo.MENSAJE_PRINCIPAL
(
	Id	INT  NOT NULL IDENTITY(1,1),
	Texto NVARCHAR(500) NOT NULL,
	...
	CONSTRAINT PK_MENSAJE_PRINCIPAL PRIMARY KEY(Id)
);
GO
...
INSERT INTO dbo.COLECTA Values
('Texto 1',getdate(),3,1,0),
('Texto 2',getdate(),4,0,0);

INSERT INTO dbo.COLECTAEMPLEADO Values
(4,1,1500,0),
(3,2,500,20);
...
INSERT INTO dbo.MENSAJE_PRINCIPAL Values
('Texto 1','Titulo 1','1/1/2018'),
('Texto 2','Titulo 2','2/1/2018'),
('Texto 3','Titulo 3','3/1/2018'),
('Texto 4','Titulo 4','4/1/2018');
...
SELECT * FROM COLECTA;
SELECT * FROM COLECTAEMPLEADO;
SELECT * FROM REPARTO;
SELECT * FROM REPARTODIARIO;
SELECT * FROM CARGO;
SELECT * FROM MENSAJE_PRINCIPAL;


SELECT COUNT(*) FROM EMPLEADO e, CARGO c WHERE e.CargoId=c.Id AND (c.Nombre='CROUPIER' 
