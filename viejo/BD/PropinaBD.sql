...
(
	...
	DiasTrabajadosEventuales INT NOT NULL,--se utiliza solo para eventuales
...
--CREATE TABLE dbo.EVENTUAL
--(
--	EmpleadoId INT  NOT NULL,
--	DiasTrabajadosEventuales INT NOT NULL,

--	CONSTRAINT PK_EVENTUAL PRIMARY KEY(EmpleadoId),
--	CONSTRAINT FK_UsuarioId_EVENTUAL FOREIGN KEY (EmpleadoId) REFERENCES dbo.EMPLEADO (UsuarioId)
--);
--GO
...
('CROUPIER',30,'PORCENTAJE_MAYOR','MESAS'),
('SUPERVIDOR_MESAS',23,'PORCENTAJE_MAYOR','MESAS'),
('CAJERO',14,'PORCENTAJE_MAYOR','CAJAS'),
('SUPERVISOR_CAJAS',14,'PORCENTAJE_MAYOR','CAJAS'),
('MARKETING',10,'PORCENTAJE_MENOR','OTROS'),
('SLOTS',10,'PORCENTAJE_MENOR','OTROS'),
('TECNICOS_SLOTS',10,'PORCENTAJE_MENOR','OTROS'),
('SOFTCOUNT',10,'PORCENTAJE_MENOR','OTROS'),
('SERVICIOS_GENERALES',10,'PORCENTAJE_MENOR','OTROS'),
('MANTENIMIENTO',10,'PORCENTAJE_MENOR','OTROS');

INSERT INTO dbo.USUARIO VALUES
('FEDERICO', 'SPERONI', 'FSPE', '123456789', 1, '42614099', '099845498', 'fsperonip@hotmail.com', 'ADMINISTRADOR'),
('EMPLEADO1', 'EMPLEADO1', 'EMP1', '123456789', 1, '42614091', '099845491', 'EMPLEADO1@hotmail.com', 'EMPLEADO'),
('EMPLEADO2', 'EMPLEADO2', 'EMP2', '123456789', 1, '42614092', '099845492', 'EMPLEADO2@hotmail.com', 'EMPLEADO');

INSERT INTO dbo.ADMINISTRADOR VALUES
(1);

INSERT INTO dbo.EMPLEADO VALUES
(1,99,0,0,2,0,0,'1/1/2012'),
(2,100,0,0,2,0,0,'1/1/2012'),
(3,101,0,0,2,0,0,'1/1/2012');
